...
$message = $errors->first('password'); ?>
                                    <span class="invalid-feedback my-red-text" role="alert">
                                        <strong><?php echo e($message); ?></strong>
                                    </span>
                                <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                <?php if(Route::has('password.request')): ?>
                                    <a class="btn btn-link my-red-text" href="<?php echo e(route('password.request')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/DigitalTest/resources/views/auth/login.blade.php ENDPATH**/ ?>